            ...
            <table class="table table-bordered  table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'distance') { ?>
                    <a href="<?php echo $sort_distance; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_distance; ?></a>
                    <?php } else { ?>
                  ...
                  <td class="text-left"><?php if ($sort == 'price') { ?>
                    ...
                    <?php } ?></td>
                    <td class="text-left"><?php if ($sort == 'invoice') { ?>
              ...
              <tbody>
                <?php if ($transports) { ?>
                <?php foreach ($transports as $result) { ?>
                <tr>
