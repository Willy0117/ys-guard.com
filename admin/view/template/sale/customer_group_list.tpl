            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="col-sm-6 text-left"><?php if ($sort == 'name') { ?>
                    <a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_name; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_name; ?>"><?php echo $column_name; ?></a>
                    <?php } ?>
                  </td>
                  <td class="col-sm-1 text-left"><?php if ($sort == 'code') { ?>
                  ...
                  <td class="col-sm-1 text-left">
                    <?php if ($sort == 'base') { ?>
                      <a href="<?php echo $sort_base; ?>" class="<?php echo strtolower($order); ?>">
                    <?php } else { ?>
                      <a href="<?php echo $sort_base; ?>">
                    <?php } ?>
                    <?php echo $column_base; ?></a>
                  </td>
                  <td class="col-sm-1 text-right"><?php if ($sort == 'sort_order') { ?>
                    <a href="<?php echo $sort_sort_order; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_sort_order; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_sort_order; ?>"><?php echo $column_sort_order; ?></a>
                    <?php } ?>
                  </td>
                  <td class="col-sm-1 text-left"><?php if ($sort == 'status') { ?>
                    <a href="<?php echo $sort_status; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_status; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_status; ?>"><?php echo $column_status; ?></a>
                    <?php } ?>
                  </td>
                  <td class="col-sm-1 text-right"><?php echo $column_action; ?></td>
                </tr>
              </thead>
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($customer_group['id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $customer_group['id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $customer_group['id']; ?>" />
                    <?php } ?></td>
                  <td class="text-left"><?php echo $customer_group['name']; ?></td>
                  <td class="text-left"><?php echo $customer_group['code']; ?></td>
                  <td class="text-left"><?php echo $customer_group['base']; ?></td>
                  <td class="text-right"><?php echo $customer_group['sort_order']; ?></td>
                  <td class="text-left"><?php echo $customer_group['status']; ?></td>
